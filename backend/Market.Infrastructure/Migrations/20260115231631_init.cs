        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageText = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasePrice = table.Column<decimal>(type: "decimal(10,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemsFilm", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItemsFilm_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderItemsFilm_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItemsProduct", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderItemsProduct_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderItemsProduct_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemsFilm_FilmId",
                table: "OrderItemsFilm",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemsFilm_OrderId",
                table: "OrderItemsFilm",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemsProduct_OrderId",
                table: "OrderItemsProduct",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItemsProduct_ProductId",
                table: "OrderItemsProduct",
                column: "ProductId");

...
using CineMart.Infrastructure.Common;
using CineMart.Infrastructure.Database;
using CineMart.Shared.Constants;
using CineMart.Shared.Options;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.Extensions.Options;

namespace CineMart.Infrastructure;
...
public static class DependencyInjection
{
        ...
        IHostEnvironment env)
    {
        ...
        // Identity hasher
        services.AddScoped<IPasswordHasher<CineMartUserEntity>, PasswordHasher<CineMartUserEntity>>();

...
public static class DependencyInjection
{
        ...
        IHostEnvironment env)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "CineMart API", Version = "v1" });
            var xml = Path.Combine(AppContext.BaseDirectory, "CineMart.API.xml");
            if (File.Exists(xml))

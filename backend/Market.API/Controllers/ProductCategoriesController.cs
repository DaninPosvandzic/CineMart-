using CineMart.Application.Modules.Catalog.ProductCategories.Commands.Delete;
using CineMart.Application.Modules.Catalog.ProductCategories.Commands.Status.Disable;
using CineMart.Application.Modules.Catalog.ProductCategories.Commands.Status.Enable;
using CineMart.Application.Modules.Catalog.ProductCategories.Commands.Create;
using CineMart.Application.Modules.Catalog.ProductCategories.Commands.Update;
using CineMart.Application.Modules.Catalog.ProductCategories.Queries.GetById;
using CineMart.Application.Modules.Catalog.ProductCategories.Queries.List;
